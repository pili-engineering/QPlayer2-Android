...
```groovy
implementation("com.qiniu:qplayer2-core:1.1.0")
implementation("com.qiniu:qplayer2-ext:1.1.0") //如果无需qplayer2-ext能力可以不引入 不影响core的使用
```
...
3. 体验demo下载：http://fir.qnsdk.com/4rg5?release_id=6346825d0d81cc09eb6c48f0
