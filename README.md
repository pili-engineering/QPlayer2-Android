...
```groovy
implementation("com.qiniu:qplayer2-core:1.2.4")
implementation("com.qiniu:qplayer2-ext:1.2.4") //如果无需qplayer2-ext能力可以不引入 不影响core的使用
```
