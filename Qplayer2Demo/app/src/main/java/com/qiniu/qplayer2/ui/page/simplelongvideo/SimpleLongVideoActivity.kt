...
//            mQSurfacePlayerView.playerControlHandler.setSpeed(2.0f)
    ...
    private fun initMediaModel() {
        ...
        builder.addStreamElement("", QURLType.QVIDEO, 0, url, true)
        url = "http://demo-videos.qnsdk.com/only-audio.m4s";
        builder.addStreamElement("", QURLType.QAUDIO, 0, url, true)
        mVideoList.add(Pair(url, builder.build(false)))
        ...
        builder.addStreamElement("", QURLType.QAUDIO_AND_VIDEO, 0, url, true, "http://video.eebbk.net")
